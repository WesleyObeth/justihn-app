...
import { ProveedorPerfil } from "@/components/portal/proveedor-perfil";
import { miPerfilAbogado } from "@/lib/supabase/perfil";

export default async function PortalLayout({ children }: { children: React.ReactNode }) {
  // Se lee en el SERVIDOR: el nombre real llega en el primer HTML, sin un
  // parpadeo de «María Castillo» antes del verdadero.
  const perfil = await miPerfilAbogado();

  return (
    <ProveedorPerfil perfil={perfil}>
      <ProveedorUpgrade>
        <HidratarStore />
